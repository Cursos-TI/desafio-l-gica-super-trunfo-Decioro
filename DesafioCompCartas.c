...
int main() {
    ...
    // Dados da Carta2: Rio de Janeiro
    ...
    // Escolha do atributo para comparação (1: População, 2: Área, 3: PIB, 4: Densidade Populacional, 5: PIB per capita)
